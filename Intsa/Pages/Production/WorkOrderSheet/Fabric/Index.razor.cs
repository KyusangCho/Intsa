...
/// 전자결재 템플릿 
/// </summary>
namespace Intsa.Pages.Production.WorkOrderSheet.Fabric
{
    public partial class Index
    {
        ...
        public DateTime MinDate { get; set; } = new DateTime(2021, 01, 05);
        public DateTime MaxDate { get; set; } = new DateTime(2021, 12, 20);
